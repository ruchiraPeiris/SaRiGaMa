...
#(10)
SELECT DATE_FORMAT(SA.attend_date, "%d-%b-%Y"), SA.is_late, CM.module_code, CM.class_type, TA.student_id, CONCAT(ST.std_first_name , ' ', ST.std_last_name) AS first_last_name 
