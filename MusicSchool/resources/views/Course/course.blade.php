    ...
    <div class="col-sm-12;" style="padding-bottom: 10%; margin-top: 5% ">
        <div class="container"
            ...
            <div class="row" style="padding-top: 2%;">
                <div class="col-md-12">
                    {{--<form action="{{route('edit_class_module')}}" method="get">--}}
                        <table class="table table-bordered" style="border: groove;">
                            ...
                            @foreach($classModules as $classModule)
                                ...
                                <tr>
                                    ...
                                    <th>{{ $classModule->class_fee_per_hr }}</th>
                                    <th>{{ $classModule->num_students }}</th>
                                    <th>{{ $classModule->teacher_fee_percentage }}</th>
                                    <th>{{ $classModule->class_type }}</th>
                                    <th>
                                        <a href="{{route('edit_class_module',[$classModule->class_module_id])}}" class="btn btn-default" style="background-color: #269abc">Edit</a>

                                    </th>
                                    <th>
                                        <a href="{{route('search_class_module_by_id',[$classModule->class_module_id])}}" class="btn btn-default" style="background-color: #ce8483;">Search</a>
