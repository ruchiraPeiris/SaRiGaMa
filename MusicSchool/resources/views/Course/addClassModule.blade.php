    ...
    <div class="col-sm-12" style="padding-bottom: 10%;">
        <div class="container" style="float: left;  border-style: inset; padding-bottom: 5%; background-color: white;">
            ...
            <form action="{{route('save_class_module')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="module_code" id="module_code">
                        ...
                        @foreach($modules as $module)
                            <option value="{{$module->module_code }}">{{$module->instrument_name}}</option>
                        @endforeach
                ...
                <div class="form-group">
                    <label for="teacher_fee_percentage">Teacher Fee Percentage:</label>
                ...
                <div class="form-group">
                    <label for="class_start_time">Module class time:</label>
                    <input type="text" class="form-control" name="class_start_time" id="class_start_time"
