...
@section('content')
    ...
    <div class="container " style="padding: 5px;">
        <div class="row">
            <div class="col-lg-12">
                <br><br>
                <form action="{{route('save_assignment',$class_module_id,$class_type)}}" method="POST">
                    {{csrf_field()}}
                    ...
                    <table class="striped">
                        ...
                        @foreach ($assignments as $assignments)
                            <tr>
                                ...
                                <td><a href='{{ route('view_assignment_marks_sheet',$class_module_id,$assignments->assignment_id ) }}'>Add</a></td>
