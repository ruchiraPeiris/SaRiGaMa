...
class Module
{
    ...
    public function getAllFromModuleAndInstrument(){
        $modules = DB::select("SELECT module_code ,CONCAT(module_code,'  ',instrument_name) AS instrument_name FROM module NATURAL JOIN instrument");
        return $modules;
    }
